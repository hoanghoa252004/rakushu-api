...
using Rakushu.Application.Usecases.Payment.ProcessSepayWebhook;
...
internal sealed class SepayWebhookEndpoint : IEndpoint
{
	public void MapEndpoint(IEndpointRouteBuilder app)
	{
		...
		group.MapPost("/ipn", handler)
			.WithName("ProcessPaymentIpn")
			.WithDescription("Processes incoming IPN notifications from SePay for bank transfers.")
			.AllowAnonymous()
